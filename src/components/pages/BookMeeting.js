          ...
          <div className="profile-content">
            <div class="profile-about">
              ...
              <div className="introduction">
                To make meeting easy, all startups and investors can sign up
                with our Matchmaking Tool. With it, you can screen all startups
                present and schedule all your meetings during and after our
                event.
              </div>
            </div>
            <div className="reviews">
              <div className="button">
                Give <b>{name}</b> reviews
              </div>
